...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ortho_3x10(
    ...
    SFT_Z,   ALT_X,   FN3_C,   FN4_V,   FN2_B,   FN1_SPC, FN5_N,   ALT_M,   CTL_ESC, SFT_ENT
  ),
  ...
  [3] = LAYOUT_ortho_3x10(
    ...
    SFT_TAB, _______, _______, _______, _______, KC_COMM, KC_DOT,  KC_SLSH, KC_SCLN, KC_QUOT,
  ...
  [4] = LAYOUT_ortho_3x10(
    ...
    SFT_TAB, _______, _______, _______, _______, KC_LABK, KC_RABK, KC_QUES, KC_COLN, KC_DQUO,
